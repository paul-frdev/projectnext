    ...
    >
      <Container className='flex justify-between items-center mb-[56px] py-2'>
        ...
        <motion.div variants={fadeIn} className='flex justify-between items-center gap-x-6'>
          ...
          <Button variant='buttonPrimaryBlueDestructive' className='flex rounded-full h-[45px] shadow-buttonShadow w-[45px] p-0 justify-center items-center hover:bg-transparent hover:border-2 hover:border-[rgba(114, 122, 237, 0.50)]'>
            <QuestionMark />
          </Button>
