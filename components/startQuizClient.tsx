  ...
  return (
    <section>
      <Container className='flex justify-center items-center h-full font-sansBold'>
        ...
        >
          <motion.h1 variants={fadeIn} className='font-body scroll-m-20 text-[26px] text-center md:text-[32px] text-[#101010] font-bold tracking-[0.5px] transition-colors mb-2'>Investment income know-how for beginners</motion.h1>
          ...
          <div className='flex flex-col justify-center items-center'>
            <motion.div variants={fadeIn} className='w-full flex flex-col justify-center items-center'>
              <Button onClick={() => route.push('/quiz')} className='max-w-[264px] w-full h-[48px] mb-6 uppercase' variant="buttonPrimaryBlue" >Take the quiz</Button>
            </motion.div>
            <Typography variants={fadeIn} className='text-[rgba(16, 16, 16, 0.75)] text-sm tracking-[0.4px] leading-[18px] mb-1' >By clicking Take the quiz, you agree with</Typography>
