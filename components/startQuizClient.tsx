...
import { fadeInUpTitle, imageZoom, staggerTextContainer } from '@/constants/variants'
  ...
  return (
    <section>
      <Container className='flex justify-center items-center h-full font-sansBold'>
        ...
        >
          <motion.h1 variants={fadeInUpTitle} className='font-body scroll-m-20 text-[26px] text-center md:text-[32px] text-[#101010] font-bold tracking-[0.5px] transition-colors mb-2'>Investment income know-how for beginners</motion.h1>
