...
export const SalesPanel = () => {
  ...
  return (
    <motion.div variants={fadeIn} className="flex justify-between items-center w-full max-w-[384px] rounded-3xl bg-bgBlue p-2">
      ...
      <motion.div variants={fadeIn}>
        <Button variant="buttonPrimaryOrange" className="uppercase bg-[#5EB25D] hover:bg-[#58A657] max-w-[127px] w-full">
          Try Now
        </Button>
      </motion.div>
    </motion.div>
