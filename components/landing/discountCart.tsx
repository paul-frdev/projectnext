...
export const DiscountCart = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      <SalesCart className="border-8 border-[#727AED] w-full max-w-[328px] flex flex-col justify-center gap-y-6 relative mb-9">
        <span className="absolute -top-[68px] -right-[8px] bg-rightCoins w-[132px] h-[178px] bg-no-repeat object-center overflow-hidden object-cover" />
        ...
        <span className="absolute -bottom-[42px] -left-[5px] bg-leftCoins w-[100px] h-[169px]  bg-no-repeat object-center overflow-hidden object-cover" />
      </SalesCart>
      <div className="w-full flex justify-center mb-6">
        <Button
          variant="buttonPrimaryBlueDestructive"
          className="bg-bgGreen hover:bg-hoverGreen border-none max-w-[328px] w-full flex justify-center items-center h-[48px] text-white uppercase shadow shadow-[rgba(94, 178, 93, 0.50)]"
        >
          TRY NOW
        </Button>
      </div>
