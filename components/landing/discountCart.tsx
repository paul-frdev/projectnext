...
import { fadeInLeft, fadeInRight, fadeInUp, LeftImageAnim, RightImageAnim, staggerTextContainer } from '@/constants/variants';
...
export const DiscountCart = () => {
  ...
  return (
    <motion.div
      ...
      <SalesCart variants={fadeInUp} className="border-8 border-[#727AED] w-full max-w-[328px] md:max-w-[1200px] flex flex-col md:flex-row justify-center gap-y-6 relative mb-9">
        <motion.span
          initial="hidden"
          whileInView="animate"
          viewport={{ once: false }}
          variants={RightImageAnim}
          className="absolute z-10 -top-[68px] md:-top-[36px] -right-[8px] md:right-[65px] bg-rightCoins md:bg-rightCoinsBig w-[132px] md:w-[149px] h-[178px] md:h-[303px] bg-no-repeat object-center overflow-hidden object-cover"
        />
        ...
        <motion.span variants={LeftImageAnim} className="absolute -bottom-[42px] md:-bottom-[40px] -left-[5px] md:left-[59px] bg-leftCoins md:bg-leftCoinsBig w-[100px] md:w-[213px] md:h-[286px] md:w-[145px] h-[169px] md:h-[191px]  bg-no-repeat object-center overflow-hidden object-cover" />
      </SalesCart>
