...
export const MoneyBack = () => {
  return (
    <motion.div
      ...
      className="mt-16 md:mt-28 flex flex-col gap-y-14 md:gap-y-0 justify-between items-center md:flex md:flex-row md:justify-between md:items-center md:gap-x-24 md:max-w-[1064px] md:ml-auto w-full">
      <motion.div variants={LeftImageAnim} className="flex w-full justify-center md:justify-end md:max-w-[176px] items-center mb-4">
        <Image src={backMoneyImage} alt="money-back" />
      </motion.div>
      <SalesCart variants={fadeInLeft} className="w-full max-w-[328px] md:max-w-[793px] bg-green flex flex-col justify-center md:justify-start items-center md:items-start gap-y-4">
