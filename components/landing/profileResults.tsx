...
export const ProfileResults = () => {
  ...
  return (
    <section className="w-full  mb-16">
      <div>
        <Title className="text-3xl md:text-4xl md:text-left tracking-[0.25px] text-basic text-center mb-6">Your profile summary:</Title>
        <div className='md:flex md:flex-wrap lg:flex-nowrap md:justify-between md:items-center md:w-full md:max-w-[800px] lg:max-w-[1200px] lg:gap-x-2 md:mb-8 m-auto'>
          <SalesCart className="max-w-[384px] md:max-w-[364px] min-[810px]:max-w-[384px] bg-bgBlue flex flex-col items-start gap-y-4 m-auto mb-4">
            <div className="flex justify-between items-center w-full">
              <Title className="text-white text-3xl md:text-4xl tracking-[0.25px]">Income</Title>
              <SalesWidget className="max-w-[73px] h-[40px] px-3 py-2 text-[16px] font-sansBold leading-[24px] tracking-[0.1px] text-[#727AED]">
                Ready
              </SalesWidget>
            </div>
            <div>
          ...
          <SalesCart className="max-w-[384px] md:max-w-[364px] min-[810px]:max-w-[384px] bg-bgGreen flex flex-col items-start gap-y-4 m-auto mb-4">
            <div className="flex justify-between items-center w-full">
              <Title className="text-white text-3xl md:text-4xl tracking-[0.25px]">Mindset</Title>
              <SalesWidget className="max-w-[73px] h-[40px] px-3 py-2 text-[16px] font-sansBold leading-[24px] tracking-[0.1px] text-green">
                Great
              </SalesWidget>
            </div>
            <div>
          ...
          <SalesCart className="max-w-[384px] md:max-w-[800px] lg:max-w-[384px] bg-gray flex flex-col items-start gap-y-4 m-auto mb-4">
            <div className="flex justify-between items-center w-full">
              <Title className="text-white text-3xl md:text-4xl tracking-[0.25px]">Knowledge</Title>
              <SalesWidget className="max-w-[89px] h-[40px] px-3 py-2 text-[16px] font-sansBold leading-[24px] tracking-[0.1px] text-basic">
                Improve
              </SalesWidget>
            </div>
            <div>
        ...
        <SalesCart className="max-w-[384px] md:max-w-[800px] lg:max-w-[1200px] flex flex-col md:gap-y-4 items-start m-auto mb-4 border-8 border-[#727AED] mb-9 md:mb-28">
          <div className="flex flex-wrap md:flex-nowrap justify-start items-start md:items-center w-full gap-y-4 md:gap-x-4">
            <Title className="text-basic text-3xl md:text-4xl md:whitespace-nowrap tracking-[0.25px] md:mb-0">Your readiness:</Title>
          ...
          <div>
            <p className="text-lg md:text-[20px] font-sansBold leading-[24px] tracking-[0.27px] leading-[24px] text-basic">
        ...
        <SalesCart className="max-w-[384px] flex flex-col items-start m-auto gap-y-6  bg-bgOrange">
          ...
          <div className='w-full'>
            <div className="w-full flex justify-start items-start flex-col">
              <SalesCart className="flex flex-col justify-start items-start gap-y-4 m-auto">
                ...
                <div className="flex w-full justify-start gap-x-3 items-center">
                  ...
                  <p className="text-[16px] text-basic font-sansBold tracking-[0.1px] leading-[24px]">
                    No need
